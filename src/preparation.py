...
from src.api import HH, SJ


class MixinPreparation:
    """Класс-миксин для валидации. Подготавливает общий список вакансий (или ваканcию от пользователя) с необходимыми
     данными"""
